...
class FilenameHeadingSyncPlugin extends obsidian.Plugin {
    constructor() {
        super(...arguments);
        this.renamingFiles = new Set();
        this.headingSyncs = new Map();
    ...
    forceSyncHeadingToFilename(file) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const previous = (_a = this.headingSyncs.get(file)) !== null && _a !== void 0 ? _a : Promise.resolve();
            const sync = previous
    ...
    syncHeadingToFilename(file) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            // Read when queued work starts so edits made while waiting are included.
            const data = yield this.loadCurrentFileContent(file);
